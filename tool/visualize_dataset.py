...
def main():
    ...
    parser.add_argument('--input', type=str, default='F:\\wenw\\work\\dataset\\dataset_no_game_4class_1212',
                       help='输入数据集路径（YOLO格式）')
    parser.add_argument('--output', type=str, default='F:\\wenw\\work\\dataset\\dataset_no_game_4class_1212-visual',
                       help='输出数据集路径（可视化后的结果）')
